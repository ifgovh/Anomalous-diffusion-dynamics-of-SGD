...
% output
print('-painters' ,'/import/headnode1/gche4213/Project3/outputfigures/superdiffusion1.svg','-dsvg','-r300')



%% plot superdiffusion for supplementary figures
% figure_width = 20;
% total_row = 1;
% total_column = 2;
% % uniform FontSize and linewidth
...
% 
% % output
% print('-painters' ,'/import/headnode1/gche4213/Project3/outputfigures/superdiffusion_SI.svg','-dsvg','-r300')
